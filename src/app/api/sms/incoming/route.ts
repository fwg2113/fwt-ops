...
//
// SECURITY: verifies X-Twilio-Signature. Without it, anyone can POST forged
// SMS events that pollute the message hub, fire email alerts, and pollute
// customer records by phone-prefix matching. Audit C5.
